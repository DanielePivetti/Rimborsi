...
class ImpiegoMezzo(db.Model):
    ...
    richiesta_id = db.Column(db.Integer, db.ForeignKey('richieste.id'), nullable=True)
    conducente = db.Column(db.String(100), nullable=False, comment="Nome e cognome del conducente del mezzo")
    localita = db.Column(db.String(200), nullable=False, comment="Località di utilizzo del mezzo")
    ...
    richiesta = db.relationship('Richiesta', backref='impieghi_mezzi', lazy=True)
